...
const customSchema = {
  ...
  properties: {
    ...
    laporan: {
      type: Type.STRING,
      description:
        "Ringkasan teknis profesional dalam Bahasa Indonesia yang menjelaskan arsitektur, perubahan yang dilakukan, serta keputusan desain utama. Jelaskan file dan folder apa saja yang dibuat, dimodifikasi, atau dihapus secara ringkas dengan format text biasa tanpa markdown.",
    },
  },
  required: ["project", "laporan"],
};
